                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                    ...
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center flex-shrink-0 ${
                      ...
                      {tx.type === 'send' ? (
                        <ArrowUpRight className={`w-5 h-5 sm:w-6 sm:h-6 ${tx.type === 'send' ? 'text-red-400' : 'text-green-400'}`} />
                      ) : (
                        <ArrowDownLeft className={`w-5 h-5 sm:w-6 sm:h-6 ${tx.type === 'send' ? 'text-red-400' : 'text-green-400'}`} />
                      )}
                    </div>
